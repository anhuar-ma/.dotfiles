...
return gears.table.join(
	...
	awful.key({ modkey }, "", hotkeys_popup.show_help, { description = "Cheat sheet", group = "Awesome" }),
	-- Tag browsing
	...
	end, { descripton = "run a command on rofi", group = "Application" }),
	...
	awful.key({ modkey, "Shift" }, "i", awful.client.floating.toggle)
)
